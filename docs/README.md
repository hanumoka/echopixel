...
│   ├── sonix-viviane-analysis.md # 기존 프로젝트 분석 (요구사항 추출)
│   └── sado-poc-analysis.md      # SADO POC 분석 (프로토콜 & 최적화)
├── roadmap/                      # 로드맵
...
| [성능 전략](./design/performance-strategy.md) | 10+ 뷰포트 최적화 방법 |
| [Cornerstone3D 분석](./research/cornerstone3d-analysis.md) | 기존 라이브러리 한계점 분석 |
| [Sonix-Viviane 분석](./research/sonix-viviane-analysis.md) | 기존 프로젝트 요구사항 추출 |
| [SADO POC 분석](./research/sado-poc-analysis.md) | DICOM 프로토콜 & 최적화 시도 |
...
### 목표
- 웹 브라우저에서 **10개 이상**의 DICOM 심초음파 영상 동시 재생
- Cornerstone3D 대비 압도적 성능 달성
